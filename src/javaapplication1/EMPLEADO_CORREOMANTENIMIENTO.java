 ...
 * @author jose
 */
public class EMPLEADO_CORREOMANTENIMIENTO extends javax.swing.JFrame {

    /**
     * Creates new form EMPLEADO_CORREOMANTENIMIENTO
     */
    public EMPLEADO_CORREOMANTENIMIENTO() {
        try {
            initComponents();
            show_Correo();
    ...
    public ArrayList<EMPLEADO_CORREO>CorreoList() throws SQLException
{
    ArrayList<EMPLEADO_CORREO>CorreoList = new ArrayList<EMPLEADO_CORREO>();
    Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/mysql","root", "1998naciojose");
    Statement st = conn.createStatement();
    ResultSet rs = st.executeQuery("SELECT * FROM mydb.EMPLEADO_CORREO;");
    EMPLEADO_CORREO CORREO;
    while(rs.next()){
       CORREO=new EMPLEADO_CORREO(
...
public void show_Correo() throws SQLException{
    ArrayList<EMPLEADO_CORREO> list = CorreoList();
    DefaultTableModel model= (DefaultTableModel)jTable1.getModel();
    Object[] row = new Object[12];
    for(int i=0 ;i<list.size();i++){
        row[0]=list.get(i).getCorreo_electronico();
        row[1]=list.get(i).getFecha_creacion();
        row[2]=list.get(i).getFecha_modificacion();
...
public void close(){
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CORREO ELECTRONICO", "FECHA CREACION", "FECHA MODIFICACION", "USUARIO CREADOR", "USUARIO MODIFICADOR", "ID EMPLEADOS"
            }
        ));
        ...
        jLabel1.setText("EMPLEADO_CORREO");
    ...
    try {
            ...
            Statement st = conn.createStatement();
                ...
                CallableStatement upperProc = conn.prepareCall("{ call mydb.PR_CREATE_EMPLEADO_CORREO(?,?,?,?) }");
    ...
    try {
            ...
            Statement st = conn.createStatement();
                ...
                CallableStatement upperProc = conn.prepareCall("{ call mydb.PR_UPDATE_EMPLEADO_CORREO(?,?) }");
                upperProc.setString(1, jTextField1.getText());
    ...
    try {
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/mysql","root", "1998naciojose");
                  CallableStatement ps = conn.prepareCall("{ call mydb.PR_DELETE_EMPLEADO_CORREO(?) }");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EMPLEADO_CORREOMANTENIMIENTO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EMPLEADO_CORREOMANTENIMIENTO().setVisible(true);
            }
        });
    }
